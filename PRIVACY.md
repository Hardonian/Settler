...
Settler supports the following data subject rights where applicable:

- **Access** — request a copy of personal data held
- **Rectification** — request correction of inaccurate data
- **Erasure** — request deletion of personal data (right to be forgotten)
- **Portability** — request data export in machine-readable format (see [DATA_PORTABILITY.md](DATA_PORTABILITY.md))
...
- The Settler platform uses essential cookies for session management and authentication.
- Analytics telemetry (if enabled) is anonymized and does not track individual users across sites.
- No third-party advertising cookies are used.

## Sub-Processors

- Settler may use third-party infrastructure providers (database hosting, email delivery, error monitoring) to deliver the service.
- Sub-processor changes are communicated through service notifications.
