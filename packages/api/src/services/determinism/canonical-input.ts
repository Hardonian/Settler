 ...
 */
export function computeRecordFingerprint(record: CanonicalTransaction | CanonicalSettlement): string {
 ...
 */
export function computeStreamFingerprint(records: AsyncIterable<CanonicalTransaction | CanonicalSettlement>): Promise<string> {
