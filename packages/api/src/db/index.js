            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (config_1.config.nodeEnv === "development") {
                        console.warn("[SECURITY WARNING] Unscoped query() called. Stack: ".concat(new Error().stack));
                    }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!tenantId ||
                        ...
                        throw new Error("[TENANT ISOLATION VIOLATION] Invalid or missing tenantId: ".concat(tenantId));
                    }
                ...
                case 4:
                    result = _a.sent();
                    return [2 /*return*/, result.rows];
                case 5: return [4 /*yield*/, TenantContext_1.TenantContext.clearTenantContext(client)];
                case 6:
                    _a.sent();
                    client.release();
                    return [7 /*endfinally*/];
...
function assertTenantScoped(sql) {
    ...
    for (var _i = 0, TENANT_SCOPED_TABLES_1 = TENANT_SCOPED_TABLES; _i < TENANT_SCOPED_TABLES_1.length; _i++) {
        ...
        if (!normalized.includes("tenant_id")) {
            var message = "TENANT ISOLATION VIOLATION: Query on \"".concat(table, "\" missing tenant_id filter. SQL: ").concat(sql.substring(0, 200));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    _a.sent();
                    throw error_2;
                case 9: return [4 /*yield*/, TenantContext_1.TenantContext.clearTenantContext(client)];
                case 10:
                    _a.sent();
                    client.release();
                    return [7 /*endfinally*/];
...
function initDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var migrationModule, error_3, message, migrationPath, migrationSQL, statements, _i, statements_1, statement, error_4, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./migrate"); }).catch(function (error) {
                        var message = error instanceof Error ? error.message : "Unknown error";
                        (0, logger_1.logWarn)("Migration runner failed, falling back to basic schema", { message: message });
                        return null;
                    })];
                case 1:
                    migrationModule = _a.sent();
                    if (!(migrationModule === null || migrationModule === void 0 ? void 0 : migrationModule.runMigrations)) return [3 /*break*/, 5];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    migrationPath = node_path_1.default.join(__dirname, "migrations", "001-initial-schema.sql");
                    ...
                    statements = migrationSQL.split(";").filter(function (s) { return s.trim().length > 0; });
                ...
                case 12:
                    ...
                    //   npx prisma db push
                    (0, logger_1.logWarn)("No legacy migration files found. Database schema is now managed via Prisma. " +
                        "Run 'npx prisma migrate deploy' or 'npx prisma db push' to set up the database.", { migrationPath: migrationPath });
                    _a.label = 13;
