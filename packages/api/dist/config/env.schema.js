...
exports.ENV_VAR_SCHEMA = void 0;
exports.getEnvVarSpec = getEnvVarSpec;
exports.getRequiredEnvVars = getRequiredEnvVars;
exports.getEnvVarsByPlatform = getEnvVarsByPlatform;
exports.getSecrets = getSecrets;
exports.validateEnvVar = validateEnvVar;
exports.ENV_VAR_SCHEMA = [
    // ============================================================================
    // CORE CONFIGURATION
    // ============================================================================
    {
 ...
 */
function getEnvVarSpec(name) {
    return exports.ENV_VAR_SCHEMA.find((spec) => spec.name === name);
}
/**
 * Get all required environment variables for a given environment
 */
function getRequiredEnvVars(environment) {
    return exports.ENV_VAR_SCHEMA.filter((spec) => spec.required &&
 ...
 */
function getEnvVarsByPlatform(platform) {
    return exports.ENV_VAR_SCHEMA.filter((spec) => spec.platforms.includes(platform));
}
/**
 * Get all secrets (sensitive environment variables)
 */
function getSecrets() {
    return exports.ENV_VAR_SCHEMA.filter((spec) => spec.secret);
}
/**
 * Validate environment variable value against spec
 */
function validateEnvVar(spec, value) {
