...
exports.ADDON_CONFIGS = void 0;
exports.getAddOnConfig = getAddOnConfig;
exports.getAllAddOnConfigs = getAllAddOnConfigs;
exports.getStandardAddOns = getStandardAddOns;
 ...
 */
function getAddOnConfig(integrationId) {
    return exports.ADDON_CONFIGS[integrationId] || null;
}
/**
 * Get all add-on configurations
 */
function getAllAddOnConfigs() {
    return Object.values(exports.ADDON_CONFIGS);
}
/**
 * Get standard add-ons
 */
function getStandardAddOns() {
    return Object.values(exports.ADDON_CONFIGS).filter((config) => config.is_standard);
}
/**
 * Get premium add-ons
 */
function getPremiumAddOns() {
    return Object.values(exports.ADDON_CONFIGS).filter((config) => !config.is_standard);
}
/**
...
async function createAddOnFromConfig(config, supabase) {
...
//# sourceMappingURL=addon-config.js.map