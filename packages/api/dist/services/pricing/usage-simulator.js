...
class UsageSimulator {
     ...
     */
    async simulateUsage(tenantId, period = 'monthly') {
     ...
     * Get historical usage
     */
    async getHistoricalUsage(tenantId, period) {
     ...
     */
    projectUsage(historical, _period) {
    ...
    calculateCost(usage) {
        ...
        return (usage.reconComparisons * pricing.reconComparison +
...
exports.UsageSimulator = UsageSimulator;
//# sourceMappingURL=usage-simulator.js.map