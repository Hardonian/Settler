...
exports.getJobFailureTemplate = getJobFailureTemplate;
exports.getJobCompletionTemplate = getJobCompletionTemplate;
/**
 * Job Failure Email Template
 */
function getJobFailureTemplate() {
    return `
    <!DOCTYPE html>
    <html>
    <head>
 ...
 */
function getJobCompletionTemplate() {
    return `
    <!DOCTYPE html>
    <html>
    <head>
