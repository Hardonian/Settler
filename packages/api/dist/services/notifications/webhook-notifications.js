 ...
 */
async function sendWebhookNotification(prisma, params) {
    ...
    try {
        ...
        (0, logger_1.logInfo)('Webhook notification sent', {
            webhookId: webhook.id,
            eventType,
            jobId,
        ...
        (0, logger_1.logError)('Failed to send webhook notification', error, {
            tenantId,
            eventType,
            jobId,
        });
            ...
            if (failedWebhook) {
                await prisma.webhookDelivery.create({
                    data: {
                        ...
                        payload: { jobId, errorMessage, jobName, eventType },
                        status: 'failed',
