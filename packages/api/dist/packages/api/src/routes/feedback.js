...
router.post("/feedback", (0, authorization_1.requirePermission)(Permissions_1.Permission.USERS_WRITE), (0, validation_1.validateRequest)(createFeedbackSchema), async (req, res) => {
    try {
        ...
        const provider = (0, registry_1.getSupportIntakeProvider)();
        ...
        (0, telemetry_1.observeCapabilityStatus)(capability, "/feedback");
        res.status(201).json({
            data: {
                id: result[0].id,
            },
        ...
        if ((0, errors_1.isMissingOptionalCapabilityDependency)(error)) {
            const capability = {
                ...(0, registry_1.getSupportIntakeProvider)().status(),
                state: "unavailable",
                available: false,
