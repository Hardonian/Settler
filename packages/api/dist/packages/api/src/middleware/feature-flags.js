...
function featureFlagsMiddleware() {
    return async (req, _res, next) => {
        try {
            ...
            const cacheKey = `feature-flags:${context.tenantId || "anonymous"}:${context.userId || "anonymous"}`;
            req.featureFlags = await (0, request_cache_1.memoizeRequestValue)(req, cacheKey, () => featureFlagService.getFlags(context));
