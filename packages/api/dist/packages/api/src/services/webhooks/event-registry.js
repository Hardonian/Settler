...
exports.EVENT_REGISTRY = exports.WebhookEventType = void 0;
...
(function (WebhookEventType) {
    // Ingestion events
    WebhookEventType["INGESTION_STARTED"] = "ingestion.started";
    WebhookEventType["INGESTION_COMPLETED"] = "ingestion.completed";
    WebhookEventType["INGESTION_FAILED"] = "ingestion.failed";
    // Reconciliation events
    WebhookEventType["RECONCILIATION_STARTED"] = "reconciliation.started";
    WebhookEventType["RECONCILIATION_COMPLETED"] = "reconciliation.completed";
    WebhookEventType["RECONCILIATION_FAILED"] = "reconciliation.failed";
    WebhookEventType["RECONCILIATION_PARTIAL"] = "reconciliation.partial";
    // Job events
    WebhookEventType["JOB_CREATED"] = "job.created";
    WebhookEventType["JOB_UPDATED"] = "job.updated";
    WebhookEventType["JOB_DELETED"] = "job.deleted";
    WebhookEventType["JOB_RUN_STARTED"] = "job.run.started";
    WebhookEventType["JOB_RUN_COMPLETED"] = "job.run.completed";
    WebhookEventType["JOB_RUN_FAILED"] = "job.run.failed";
    // Export events
    WebhookEventType["EXPORT_STARTED"] = "export.started";
    WebhookEventType["EXPORT_COMPLETED"] = "export.completed";
    WebhookEventType["EXPORT_FAILED"] = "export.failed";
    // Exception events
    WebhookEventType["EXCEPTION_CREATED"] = "exception.created";
    WebhookEventType["EXCEPTION_RESOLVED"] = "exception.resolved";
    WebhookEventType["EXCEPTION_UPDATED"] = "exception.updated";
    // Account events
    WebhookEventType["ACCOUNT_CREATED"] = "account.created";
    WebhookEventType["ACCOUNT_UPDATED"] = "account.updated";
    WebhookEventType["ACCOUNT_SUSPENDED"] = "account.suspended";
    // API key events
    WebhookEventType["API_KEY_CREATED"] = "api_key.created";
    WebhookEventType["API_KEY_REVOKED"] = "api_key.revoked";
    WebhookEventType["API_KEY_ROTATED"] = "api_key.rotated";
...
function getPublicEvents() {
    return Object.values(exports.EVENT_REGISTRY).filter(event => event.public);
}
/**
 * Validate event type
 */
...
function getEventMetadata(eventType) {
    return exports.EVENT_REGISTRY[eventType];
}
/**
...
function validateEventPayload(eventType, payload) {
    ...
    const requiredFields = metadata.schema.required || [];
    const errors = [];
