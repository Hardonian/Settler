...
class ReconciliationEvents {
    ...
    static ReconciliationPaused(reconciliationId, data, tenantId, userId, correlationId) {
        return (0, EventEnvelope_1.createEventEnvelope)(reconciliationId, "reconciliation", "ReconciliationPaused", data, (0, EventEnvelope_1.createEventMetadata)(tenantId, userId, correlationId), 1);
    }
    static ReconciliationResumed(reconciliationId, data, tenantId, userId, correlationId) {
        return (0, EventEnvelope_1.createEventEnvelope)(reconciliationId, "reconciliation", "ReconciliationResumed", data, (0, EventEnvelope_1.createEventMetadata)(tenantId, userId, correlationId), 1);
    }
