...
async function invalidateTenantCache(tenantId) {
    await (0, tenant_cache_1.invalidateTenantCacheKeys)(tenantId);
    const patterns = [
        (0, cache_1.cacheKey)("tenant", tenantId),
        (0, cache_1.cacheKey)("tenant", tenantId, "*"),
        (0, tenant_cache_1.getTenantCacheIndexKey)(tenantId),
        (0, cache_1.cacheKey)("tenant", "lookup", "id", tenantId),
        // Legacy cache namespaces (defense-in-depth)
        (0, cache_1.cacheKey)("tenants", tenantId),
        (0, cache_1.cacheKey)("tenants", tenantId, "*"),
        (0, cache_1.cacheKey)("tenantById", tenantId),
        (0, cache_1.cacheKey)("tenantBySlug", "*"),
        (0, cache_1.cacheKey)("tenantByDomain", "*"),
        (0, cache_1.cacheKey)("tenant", "slug", "*"),
        (0, cache_1.cacheKey)("tenant", "domain", "*"),
    ];
    for (const pattern of patterns) {
        if (pattern.includes("*")) {
            await (0, cache_1.delPattern)(pattern);
