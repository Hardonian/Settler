...
export declare const httpRequestDuration: Histogram<"route" | "tenant_id" | "method" | "status_code" | "tier">;
export declare const httpRequestTotal: Counter<"route" | "tenant_id" | "method" | "status_code" | "tier">;
export declare const httpRequestErrors: Counter<"route" | "tenant_id" | "method" | "tier" | "error_type">;
export declare const reconciliationsTotal: Counter<"status" | "tenant_id" | "job_id" | "tier">;
...
export declare const queueDepth: Gauge<"tenant_id" | "priority" | "queue_name">;
