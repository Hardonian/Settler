...
exports.WixStoresAdapter = void 0;
/**
 * Wix Stores Adapter
 * Fetches order data from Wix Stores API
 */
class WixStoresAdapter {
    name = "wix-stores";
    version = "1.0.0";
    async fetch(options) {
        ...
        return orders.map((order) => this.normalize(order));
    }
    normalize(data) {
        const order = data;
        const normalized = {
...
exports.WixStoresAdapter = WixStoresAdapter;
//# sourceMappingURL=wix-stores.js.map