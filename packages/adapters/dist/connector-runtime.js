...
class ConnectorRuntime {
    ...
    async updateSyncRun(syncRunId, updates) {
        ...
        if (updates.persistenceStatus)
            updateData.persistence_status = updates.persistenceStatus;
    ...
    async saveNormalizedData(tenantId, connectorId, syncRunId, data) {
        ...
        const stageResults = [];
        const markStage = (stage, attempted, completed) => {
        ...
        try {
            ...
            ], { onConflict: "connector_id,event_id", ignoreDuplicates: false }, connectorId, "sync_recovery_required");
            await this.updateSyncRun(syncRunId, {
