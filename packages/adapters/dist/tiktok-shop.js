...
exports.TikTokShopAdapter = void 0;
/**
    ...
    async fetch(options) {
        ...
        try {
            ...
            if (shopResponse.ok) {
                ...
                results.push(...orders.map((order) => this.normalizeShopOrder(order)));
            }
        }
        catch (error) {
        ...
        try {
            ...
            if (adsResponse.ok) {
                ...
                results.push(...reports.map((report) => this.normalizeAdsSpend(report)));
            }
        }
        catch (error) {
...
exports.TikTokShopAdapter = TikTokShopAdapter;
//# sourceMappingURL=tiktok-shop.js.map