...
exports.GA4DeepSyncAdapter = void 0;
/**
 * Google Analytics GA4 Deep Sync Adapter
 * Fetches e-commerce event data from GA4 API
 */
class GA4DeepSyncAdapter {
    name = "ga4-deep-sync";
    version = "1.0.0";
    async fetch(options) {
        const { config, dateRange } = options;
        const propertyId = config.propertyId;
        const credentials = config.credentials; // JSON service account credentials
...
exports.GA4DeepSyncAdapter = GA4DeepSyncAdapter;
//# sourceMappingURL=ga4-deep-sync.js.map