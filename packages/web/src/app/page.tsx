...
const InvestorMetrics = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.InvestorMetrics })), { ssr: true });
const LiveMetricsCounter = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.LiveMetricsCounter })), { ssr: false });
const ValueProposition = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.ValueProposition })), { ssr: true });
const SocialProofCounter = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.SocialProofCounter })), { ssr: true });
const UrgencyBanner = dynamic<{ variant?: 'default' | 'minimal' | 'prominent'; className?: string }>(() => import("../components/marketing/index").then(mod => ({ default: mod.UrgencyBanner })), { ssr: true });
const InvestorPitch = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.InvestorPitch })), { ssr: true });
const TestimonialCarousel = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.TestimonialCarousel })), { ssr: true });
...
const InfographicSection = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.InfographicSection })), { ssr: true });
