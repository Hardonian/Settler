...
const InvestorMetrics = dynamic(() => import("../components/marketing/InvestorMetrics.tsx").then(mod => ({ default: mod.InvestorMetrics })), { ssr: true });
const LiveMetricsCounter = dynamic(() => import("../components/marketing/LiveMetricsCounter.tsx").then(mod => ({ default: mod.LiveMetricsCounter })), { ssr: false });
const ValueProposition = dynamic(() => import("../components/marketing/ValueProposition.tsx").then(mod => ({ default: mod.ValueProposition })), { ssr: true });
const SocialProofCounter = dynamic(() => import("../components/marketing/SocialProofCounter.tsx").then(mod => ({ default: mod.SocialProofCounter })), { ssr: true });
...
const InvestorPitch = dynamic(() => import("../components/marketing/InvestorPitch.tsx").then(mod => ({ default: mod.InvestorPitch })), { ssr: true });
const TestimonialCarousel = dynamic(() => import("../components/marketing/TestimonialCarousel.tsx").then(mod => ({ default: mod.TestimonialCarousel })), { ssr: true });
...
const InfographicSection = dynamic(() => import("../components/marketing/InfographicSection.tsx").then(mod => ({ default: mod.InfographicSection })), { ssr: true });
