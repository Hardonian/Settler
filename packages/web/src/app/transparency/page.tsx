              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    ensuring that comparisons are mathematically sound and consistent across
                    systems.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    The final state is written to an immutable ledger and hash-linked. This creates
                    a tamper-evident proofpack that satisfies the most rigorous audit requirements.
                  </p>
                </div>
              </div>
            </Section>
            ...
            <Section className="py-24 bg-muted/30 border-y border-border/40">
              <div className="max-w-4xl mx-auto text-center space-y-8">
                ...
                <p className="text-lg text-muted-foreground">
                  Settler provides the infrastructure to enforce your financial policies at scale.
                  Our safety mechanisms are structural, not elective.
                </p>
