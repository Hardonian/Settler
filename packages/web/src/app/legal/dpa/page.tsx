  ...
  return (
    <AnimatedPageWrapper aria-label="Data Processing Agreement page">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold mb-8 text-slate-900 dark:text-white">Data Processing Agreement</h1>
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            This Data Processing Agreement ("DPA") forms part of the Terms of Service between Settler Inc. ("Settler") 
            and the Customer. This DPA applies to the processing of Personal Data by Settler on behalf of the Customer.
          </p>

          <h3>1. Definitions</h3>
          <p>
            <strong>"Controller"</strong> means the entity which determines the purposes and means of the processing of Personal Data.<br/>
            <strong>"Processor"</strong> means the entity which processes Personal Data on behalf of the Controller.<br/>
          ...
          <p>
            Settler shall process Personal Data only on documented instructions from the Customer, including with regard 
            to transfers of Personal Data to a third country or an international organization, unless required to do so 
            by applicable law.
          </p>

          <h3>3. Confidentiality</h3>
          <p>
            Settler ensures that persons authorized to process the Personal Data have committed themselves to confidentiality 
            or are under an appropriate statutory obligation of confidentiality.
          </p>

          <h3>4. Security of Processing</h3>
          <p>
            Settler takes all measures required pursuant to Article 32 of the GDPR (Security of processing), including 
            encryption of personal data, the ability to ensure the ongoing confidentiality, integrity, availability 
          ...
          <div className="mt-12 p-6 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800">
            ...
            <p className="mb-4 text-sm">
              Enterprise customers can request a countersigned copy of this DPA by contacting our legal team.
            </p>
            <a href="mailto:legal@settler.dev" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
