    ...
    <AnimatedPageWrapper aria-label="Cookie Policy page">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>Cookies are stored on your device for varying periods:</p>
          <ul>
            <li>
            ...
            <li>
              <strong>Consent preferences:</strong> Stored for up to 365 days
            </li>
          </ul>

          <h3>7. Your Rights</h3>
          <p>Depending on your location, you may have certain rights regarding cookies:</p>
          <ul>
          ...
          <div className="mt-8 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg">
            <p className="text-sm text-muted-foreground mb-0">
              <strong>Note:</strong> This policy is provided for informational purposes only and
              does not constitute legal advice. Please consult with a legal professional for advice
