      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none mb-12">
          <p className="text-lg text-slate-600 dark:text-slate-300">
            Settler engages the following third-party entities to assist in connection with the provision of our services. 
            Prior to engaging any third-party subprocessor, we perform diligence to evaluate their privacy, security, and confidentiality practices.
          </p>
        ...
        <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          <h3 className="text-lg font-semibold mb-2 text-blue-900 dark:text-blue-100">Updates to this list</h3>
          <p className="text-blue-800 dark:text-blue-200 text-sm">
            As our business grows and evolves, the subprocessors we engage may also change. We will provide the owner of the Customer's account 
            with notice of any new subprocessors to the extent required under the Agreement, along with posting such updates here.
            You can subscribe to updates by contacting privacy@settler.dev.
          </p>
        </div>
      </div>
      <Footer />
