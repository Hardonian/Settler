    ...
    <AdminErrorBoundary>
      ...
      <div className="flex h-screen bg-slate-50 dark:bg-slate-900">
        ...
        <aside className="hidden lg:flex w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex-col fixed h-full z-10">
          ...
          <nav id="admin-navigation" className="flex-1 p-4 space-y-1 overflow-y-auto" aria-label="Admin navigation">
            <div className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2 px-2">
              Operations
            </div>
            <Link href="/admin">
              <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Dashboard overview">
                <LayoutDashboard size={18} aria-hidden="true" /> Dashboard
              </Button>
            </Link>
            <Link href="/admin/ops">
              <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Operations console">
                <Activity size={18} aria-hidden="true" /> Ops Console
              </Button>
            </Link>
            <Link href="/admin/exceptions">
              <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Exception queue">
                <AlertTriangle size={18} aria-hidden="true" /> Exceptions
              </Button>
            </Link>
            <Link href="/admin/runs">
              <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Reconciliation runs">
                <PlayCircle size={18} aria-hidden="true" /> Runs
              </Button>
            </Link>
            <Link href="/admin/audit">
              <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Audit trail">
            ...
            <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800">
              ...
              <Link href="/admin/pages">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Pages management">
                  <FileText size={18} aria-hidden="true" /> Pages
                </Button>
              </Link>
              <Link href="/admin/experiments">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Experiments">
                  <FlaskConical size={18} aria-hidden="true" /> Experiments
                </Button>
              </Link>
              <Link href="/admin/branding">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Branding">
                  <Palette size={18} aria-hidden="true" /> Branding
                </Button>
              </Link>
              <Link href="/admin/flags">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Feature flags">
                  <Flag size={18} aria-hidden="true" /> Feature Flags
                </Button>
              </Link>
              <Link href="/admin/webhooks">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Webhooks">
                  <FlaskConical size={18} aria-hidden="true" /> Webhooks
                </Button>
              </Link>
              <Link href="/admin/monitoring">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Monitoring">
                  <Activity size={18} aria-hidden="true" /> Monitoring
                </Button>
              </Link>
              <Link href="/admin/analytics">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Analytics">
                  <BarChart3 size={18} aria-hidden="true" /> Analytics
                </Button>
              </Link>
              <Link href="/admin/settings">
                <Button variant="ghost" className="w-full justify-start gap-2" aria-label="Settings">
