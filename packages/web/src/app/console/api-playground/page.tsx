            ...
            <Tabs defaultValue="headers">
              ...
              <TabsContent value="headers" className="space-y-2">
                <div className="text-sm text-slate-600 dark:text-slate-400 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                  <strong>💡 Automatic Headers:</strong> Content-Type and Authorization headers are added automatically based on your API key and request body.
                </div>
                <div className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                  Custom headers can be added via the API directly. This interface focuses on the request body.
                </div>
              </TabsContent>
