  ...
  const startRecon = async (): Promise<void> => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError({
          message:
            ...
            `Failed to create reconciliation job (${res.status})`,
      ...
      const errorMessage =
        err instanceof Error
          ? err.name === "AbortError"
            ? "Reconciliation timed out after 60 seconds"
            : err.message
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Test reconciliation jobs with real-time progress tracking and detailed results.
          </p>
        </div>
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-green-800 dark:text-green-400">
                        ...
                        This would have taken approximately {Math.ceil((result.matched * 2) / 60)}{" "}
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                    ...
                    <div className="font-bold text-2xl text-red-700 dark:text-red-400">
                      {result.unmatched}
                    </div>
                  </div>
                  <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <div className="font-bold text-2xl text-amber-700 dark:text-amber-400">
                      {result.conflicts}
                    </div>
                  </div>
                </div>
                <div className="p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800 text-center">
                  ...
                  <div className="font-bold text-4xl text-blue-700 dark:text-blue-400 mb-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-amber-800 dark:text-amber-400">
                          {result.unmatched} transaction{result.unmatched !== 1 ? "s" : ""} couldn't
                          be automatically matched. Review them to ensure accuracy.
                        </p>
                      </div>
                    </div>
                  </div>
