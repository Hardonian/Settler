  ...
  const evaluate = async () => {
      ...
      setError({
        message:
          err instanceof Error
            ? err.message
            : "Invalid JSON context. Please provide a valid JSON object.",
        code: "INVALID_JSON",
      });
      setIsRunning(false);
      return;
    ...
    try {
      ...
      if (!res.ok) {
        setError({
          message:
            (data as { message?: string }).message || `Failed to evaluate flag (${res.status})`,
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Evaluate feature flags with different user contexts and environments.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Button
                  ...
                  size="lg"
                  disabled={
                    isRunning || !flagKey || (requestLimit !== -1 && requestCount >= requestLimit)
                  }
                >
                  {isRunning ? (
                    <>
            ...
            {result ? (
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    {result.enabled ? (
                      ...
                      <>
                        ...
                        <span className="font-bold text-2xl text-red-700 dark:text-red-400">
                          Disabled
                        </span>
                      </>
                    )}
              ...
              <div className="text-center py-12 text-slate-500 dark:text-slate-400">
                ...
                <p className="text-sm italic">
                  Enter flag key and context, then click "Evaluate Flag".
                </p>
              </div>
            )}
          </CardContent>
