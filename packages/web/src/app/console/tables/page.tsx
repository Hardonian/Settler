    ...
    <SubscriptionGate requiredTier="subscribed_unpaid" feature="API Service Tables">
      <div className="container mx-auto p-6">
        ...
        <p className="text-slate-600 mb-6">
          Browse and manage tables for Settler's core API services: Receipts, Reconciliation,
          Feature Flags, and Webhooks. Use this to test API calls, webhooks, CLI commands, and SDK
          operations.
        </p>
