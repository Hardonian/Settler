...
const API_EXAMPLES = {
  ...
  -H "Authorization: Bearer \${SETTLER_API_TOKEN}" \\
  -F "file=@receipt.pdf"`,
      },
      {
        title: "Get Receipt",
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Test API calls, webhooks, CLI commands, and SDK operations for Settler&apos;s core
            services.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg border">
              <div className="flex justify-between items-center p-4 border-b">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={copyCode}
                    className="px-3 py-1 text-sm border rounded hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2"
                  >
              ...
              <div className="p-4">
                <textarea
                  ...
                  className="w-full h-64 font-mono text-sm border rounded p-4 bg-slate-50 dark:bg-slate-900"
              ...
              {loading && (
                <div className="p-4 border-t text-center text-slate-500 dark:text-slate-400">
                  Executing...
                </div>
              )}
            </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
          <Link
            ...
            className="p-4 border rounded hover:bg-slate-50 dark:hover:bg-slate-800"
          >
            <div className="font-semibold">Receipts Tables</div>
            <div className="text-sm text-slate-500 dark:text-slate-400">View receipt data</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-slate-500 dark:text-slate-400">View recon jobs</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-slate-500 dark:text-slate-400">View flags</div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="text-sm text-slate-500 dark:text-slate-400">View webhooks</div>
          </Link>
        </div>
      </div>
    </SubscriptionGate>
