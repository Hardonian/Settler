              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                  ...
                  <p className="text-sm text-red-700 dark:text-red-300 mt-2">
                    Plus $5K-$15K/month maintenance
                  </p>
                </div>
              </div>
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-lg font-semibold text-blue-900 dark:text-blue-300 mb-2">
                  Your Savings with Settler:
                </p>
                <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">
                  $49,000+ in first year
                </p>
                <p className="text-sm text-blue-700 dark:text-blue-300 mt-2">
                  Plus 3-6 months of development time saved
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            {[
              {
                ...
                description:
                  "Get started in 5 minutes vs. 3-6 months of development. Start your free trial today.",
                icon: <Zap className="w-6 h-6 text-blue-600" />,
              },
              {
                title: "Lowest Total Cost",
                description:
                  "Save $50,000+ in first year compared to building in-house. No upfront costs.",
                icon: <DollarSign className="w-6 h-6 text-green-600" />,
              },
              {
                title: "99.7% Accuracy",
                description:
                  "Higher accuracy than most in-house solutions. Automated matching eliminates human error.",
                icon: <Check className="w-6 h-6 text-purple-600" />,
              },
              {
                title: "10+ Pre-Built Adapters",
                description:
                  "Connect Shopify, Stripe, PayPal, and more in minutes. No custom code required.",
                icon: <Check className="w-6 h-6 text-indigo-600" />,
              },
              {
                title: "Managed Infrastructure",
                description:
                  "We handle scaling, maintenance, and updates. You focus on your business.",
                icon: <Check className="w-6 h-6 text-cyan-600" />,
              },
              {
                title: "Enterprise Support",
                description:
                  "Priority support, SLA guarantees, and dedicated account managers for enterprise customers.",
