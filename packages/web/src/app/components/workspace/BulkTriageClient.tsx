...
import { CheckCircle2, ClipboardList, Copy, ExternalLink, Filter, Search, TrendingUp, X } from "lucide-react";
...
export function BulkTriageClient() {
  const { items, filters, setFilters, selectedAction, setSelectedAction, isLoading, error, refresh, applyAction } = useBulkTriage();
