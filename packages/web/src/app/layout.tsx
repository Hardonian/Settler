...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      ...(SETTLER_IMAGES.favicon.webpPath ? [{ url: SETTLER_IMAGES.favicon.webpPath, type: "image/webp", sizes: `${SETTLER_IMAGES.favicon.width}x${SETTLER_IMAGES.favicon.height}` }] : []),
      ...
      ...(SETTLER_IMAGES.favicon192.webpPath ? [{ url: SETTLER_IMAGES.favicon192.webpPath, type: "image/webp", sizes: "192x192" }] : []),
      { url: SETTLER_IMAGES.favicon192.path, type: SETTLER_IMAGES.favicon192.mimeType, sizes: "192x192" },
      ...(SETTLER_IMAGES.favicon512.webpPath ? [{ url: SETTLER_IMAGES.favicon512.webpPath, type: "image/webp", sizes: "512x512" }] : []),
