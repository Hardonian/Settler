...
type SiderealTab = "console" | "flow" | "crucible" | "threats" | "merkle";

export default function SiderealPage() {
  const [activeTab, setActiveTab] = useState<SiderealTab>("console");
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground dark:bg-slate-950 dark:text-slate-100 selection:bg-cyan-500 selection:text-slate-950">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 pt-28 pb-24 sm:px-6 lg:px-8">
        ...
        {/* Interactive Sidereal Engine Mode Switcher */}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1 max-w-xl">
                Install Settler Sidereal across your backend stack with native client SDKs
                engineered for TypeScript, Python, Go, and Rust.
              </p>
            </div>
        ...
        <section className="rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-950/40 via-slate-900/80 to-purple-950/40 p-8 sm:p-12 text-center backdrop-blur-lg">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">
              Ready to Replace Fragile ETL with Sidereal?
            </h2>
