    ...
    <AnimatedPageWrapper aria-label="Changelog page">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          {posts.map((post) => (
            <article key={post.slug} className="relative flex flex-col gap-4 border-l pl-8 border-slate-200 dark:border-slate-800 pb-8 last:pb-0">
              ...
              <div className="flex flex-col gap-1">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">
                  <Link href={`/changelog/${post.slug}`} className="hover:text-blue-600 dark:hover:text-blue-400">
                    {post.title}
                  </Link>
                </h2>
              </div>
              ...
              <Link href={`/changelog/${post.slug}`} className="text-blue-600 dark:text-blue-400 font-medium hover:underline w-fit">
                Read more &rarr;
              </Link>
            </article>
          ))}
