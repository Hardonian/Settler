                ...
                pendingEvents.push({
                  event: {
                    ...
                    kpis: {
                      ...
                      unmatchedCount:
                        (recentRuns.unmatchedSourceCount || 0) +
                        (recentRuns.unmatchedTargetCount || 0),
                      confidenceAvg: recentRuns.confidenceAvg
                        ? Number(recentRuns.confidenceAvg)
                        : null,
                    },
                    timestamp: new Date().toISOString(),
                  } as any,
            ...
            if (channels.includes("exceptions")) {
              ...
              if (recentExceptions.length > 0 && recentExceptions[0]) {
                ...
                const added = recentExceptions.map((ex: (typeof recentExceptions)[0]) => ({
                  ...
                  status: (ex.acknowledged ? "resolved" : "new") as
                    | "new"
                    | "in_review"
                    | "resolved"
                    | "exported",
