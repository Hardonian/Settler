    ...
    async function GET(request: NextRequest) {
      ...
      try {
        ...
        if (!authContext.billingAccountId) {
          logger.info("No billing account in auth context, looking up", {
            correlationId,
            userId: authContext.userId,
          });
          ...
          logger.info("Found billing account, listing receipts", {
            correlationId,
        ...
        logger.info("Using billing account from auth context", {
          correlationId,
          billingAccountId: authContext.billingAccountId,
        });
