        ...
        <Card className="max-w-md">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-slate-600 dark:text-slate-400">Verifying your subscription...</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="max-w-md">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Your payment was processed, but we couldn't verify your subscription status. Please
              wait a moment and check your billing page.
            </p>
            <div className="flex gap-2">
              <Button onClick={() => router.push("/console/billing")}>Go to Billing</Button>
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <Card className="max-w-md">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Thank you for subscribing! Your plan is now active and you can start using all the
            features.
          </p>
          <div className="flex gap-2">
            <Button asChild>
