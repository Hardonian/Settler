...
export default function Pricing() {
  const plans = [
    ...
    },
    {
      name: 'Growth',
      price: '$299',
      description: 'Compliance-ready infrastructure with SOC 2 Type II planned. Handle 100k matches with complete audit trails and deterministic guarantees.',
      reconciliationVolume: '100,000/month',
      exceptionRate: '1% included',
      example: '100k reconciliations = $299/month',
      valueProposition: 'Eliminates $106K-$724K+ in annual risk. SOC 2 Type II planned. Complete audit trails. Deterministic guarantees.',
      limits: ['100,000 reconciliations/month', 'Unlimited scheduled jobs', 'Priority support (4h)', 'Advanced integrations', 'SOC 2 planned', '1-year retention'],
      cta: 'Start Free Trial',
      ctaLink: '/signup',
      popular: false,
    },
