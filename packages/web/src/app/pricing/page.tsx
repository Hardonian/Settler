...
const ROICalculator = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.ROICalculator })), { ssr: true });
const ComparisonTable = dynamic(() => import("../components/marketing/index").then(mod => ({ default: mod.ComparisonTable })), { ssr: true });
