  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Recommendations based on your usage patterns</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {highlightInsights.length === 0 && promoteInsights.length === 0 && (
          <p className="text-sm text-muted-foreground">
            No specific recommendations at this time. Keep using Settler to see personalized
            insights.
          </p>
        )}
      </CardContent>
