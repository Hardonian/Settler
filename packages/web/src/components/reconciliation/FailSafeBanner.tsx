      ...
      <CardContent className="pt-6">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <div
              className={`w-10 h-10 rounded-full ${colorClasses.bg} border-2 ${colorClasses.border} flex items-center justify-center`}
            >
          ...
          <div className="flex-1 min-w-0">
            ...
            {isPartial && (
              <p className={`${colorClasses.textSecondary} mb-3 text-sm`}>
                This reconciliation completed with partial results. Some transactions may not have
                been processed.
              </p>
            )}
            ...
            {result.errors.length > 0 && (
              <div className="mb-3">
                ...
                <ul
                  className={`${colorClasses.textSecondary} text-sm list-disc list-inside space-y-1`}
                >
