...
const MILESTONE_CONFIGS: Record<MilestoneType, MilestoneConfig> = {
  first_api_key: {
    ...
    description: 'You\'ve created your first API key. You can now start using Settler APIs in your applications.',
  ...
  first_reconciliation: {
    ...
    description: 'Congratulations! You\'ve completed your first reconciliation. You\'re now saving time on manual matching.',
  ...
  first_receipt_parsed: {
    ...
    description: 'You\'ve successfully parsed your first receipt. Settler extracted all the key information automatically.',
  ...
  first_feature_flag: {
    ...
    description: 'You\'ve created your first feature flag. Start controlling feature rollouts programmatically.',
  ...
  hundred_reconciliations: {
    ...
    description: 'Amazing! You\'ve completed 100 reconciliations. You\'re saving hours of manual work every week.',
    ctaLabel: 'View Dashboard',
    ctaUrl: '/dashboard',
    color: 'green',
  },
...
export function MilestoneCelebration({ 
  ...
  return (
    <Card className={`${colors.border} ${colors.bg} shadow-lg mb-6 animate-in slide-in-from-top-4 duration-500`}>
      <CardContent className="pt-6">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <div className={`w-12 h-12 rounded-full ${colors.iconBg} flex items-center justify-center animate-pulse`}>
