        ...
        <div className="px-6 pt-2 pb-4 border-b border-slate-100 flex items-start justify-between">
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="material-symbols-outlined text-emerald-600 text-[18px] font-variation-settings-FILL1">check_circle</span>
              <span className="text-sm font-medium text-slate-600">Healthy • Last synced 2m ago</span>
            </div>
          </div>
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="bg-slate-50 p-3 space-y-2 border-b border-slate-100">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="px-1.5 py-0.5 rounded bg-white border border-slate-200 text-slate-500 font-mono text-[10px]">string</span>
                </div>
                <div className="flex justify-between items-center text-xs">
                  <span className="font-mono font-medium text-slate-600">amount</span>
                  <span className="px-1.5 py-0.5 rounded bg-white border border-slate-200 text-slate-500 font-mono text-[10px]">integer</span>
                </div>
                <div className="flex justify-between items-center text-xs">
