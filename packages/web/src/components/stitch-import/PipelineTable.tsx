    ...
    <main className="flex-1 px-4 py-4 pb-24 space-y-4">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          ...
          <input className="w-full rounded-lg bg-white dark:bg-[#192633] border border-slate-200 dark:border-slate-700 py-2.5 pl-10 pr-4 text-sm text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-slate-400 outline-none transition-all" placeholder="Search pipelines..." type="text" />
        </div>
        ...
        <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-[#192633] border border-slate-200 dark:border-slate-700 p-4 shadow-sm transition-all hover:border-primary/50">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-sm">payment_reconciliation_v2</h3>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="inline-flex items-center rounded-md bg-green-500/10 px-2 py-0.5 text-xs font-medium text-green-500 ring-1 ring-inset ring-green-500/20">Healthy</span>
          ...
          <div className="grid grid-cols-2 gap-4 mb-3">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-slate-700 dark:text-slate-300 truncate">Stripe Connect</span>
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-[10px] uppercase tracking-wider text-slate-500 font-semibold">Output</span>
              <div className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[16px] text-purple-400">webhook</span>
                <span className="text-xs text-slate-700 dark:text-slate-300 truncate">S3: settled-trans</span>
              </div>
            </div>
          </div>
          <div className="flex items-end justify-between border-t border-slate-100 dark:border-slate-800 pt-3 mt-1">
            <div className="flex flex-col gap-1 w-full mr-4">
              ...
              {/* Sparkline (SVG) */}
              <svg className="h-6 w-full text-green-500 stroke-current" fill="none" preserveAspectRatio="none" viewBox="0 0 100 20">
                <path d="M0 10 Q 10 15, 20 10 T 40 10 T 60 5 T 80 12 T 100 8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
              </svg>
            </div>
        ...
        <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-[#192633] border border-red-200 dark:border-red-900/30 p-4 shadow-sm transition-all">
          ...
          <div className="flex items-start justify-between mb-3 pl-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-sm">ledger_sync_daily</h3>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="inline-flex items-center rounded-md bg-red-500/10 px-2 py-0.5 text-xs font-medium text-red-500 ring-1 ring-inset ring-red-500/20">Critical</span>
          ...
          <div className="grid grid-cols-2 gap-4 mb-3 pl-2">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-slate-700 dark:text-slate-300 truncate">Postgres DB</span>
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-[10px] uppercase tracking-wider text-slate-500 font-semibold">Output</span>
              <div className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[16px] text-orange-400">api</span>
                <span className="text-xs text-slate-700 dark:text-slate-300 truncate">Internal API</span>
              </div>
            </div>
          </div>
          <div className="flex items-end justify-between border-t border-slate-100 dark:border-slate-800 pt-3 mt-1 pl-2">
            <div className="flex flex-col gap-1 w-full mr-4">
              <span className="text-[10px] text-slate-400">Error Trend (24h)</span>
              <svg className="h-6 w-full text-red-500 stroke-current" fill="none" preserveAspectRatio="none" viewBox="0 0 100 20">
                <path d="M0 18 Q 20 18, 40 10 T 60 5 L 80 15 L 100 2" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
              </svg>
            </div>
            <div className="flex gap-2 shrink-0">
        ...
        <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-[#192633] border border-slate-200 dark:border-slate-700 p-4 shadow-sm opacity-75 hover:opacity-100 transition-all">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-sm">fraud_detection_stream</h3>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="inline-flex items-center rounded-md bg-slate-100 dark:bg-slate-800 px-2 py-0.5 text-xs font-medium text-slate-600 dark:text-slate-400 ring-1 ring-inset ring-slate-500/10">Paused</span>
        ...
        <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-[#192633] border border-slate-200 dark:border-slate-700 p-4 shadow-sm transition-all hover:border-primary/50">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white text-sm">inventory_aggregator</h3>
                <div className="flex items-center gap-2 mt-0.5">
                  <span className="inline-flex items-center rounded-md bg-yellow-500/10 px-2 py-0.5 text-xs font-medium text-yellow-500 ring-1 ring-inset ring-yellow-500/20">Degraded</span>
          ...
          <div className="flex items-end justify-between border-t border-slate-100 dark:border-slate-800 pt-3 mt-1">
            <div className="flex flex-col gap-1 w-full mr-4">
              <span className="text-[10px] text-slate-400">Error Trend (24h)</span>
              <svg className="h-6 w-full text-yellow-500 stroke-current" fill="none" preserveAspectRatio="none" viewBox="0 0 100 20">
                <path d="M0 15 Q 15 15, 25 10 T 50 12 T 75 5 T 100 8" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
              </svg>
            </div>
            <div className="flex gap-2 shrink-0">
              <button className="flex items-center justify-center h-8 px-3 rounded-lg bg-slate-100 dark:bg-slate-800 text-xs font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
