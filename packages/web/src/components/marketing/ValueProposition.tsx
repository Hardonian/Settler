...
const valueProps: ValueProp[] = [
  {
    icon: Clock,
    title: 'Save 95% of Reconciliation Time',
    description: 'Automate manual reconciliation processes',
    benefit: 'Free up your team for strategic work',
  ...
  },
  {
    ...
    description: 'Simple API integration, no complex setup',
    benefit: 'Start reconciling today, not next quarter',
    gradient: 'from-purple-500 to-pink-500',
  },
  {
    icon: TrendingUp,
    title: 'Scale Without Limits',
    description: 'Process millions of transactions effortlessly',
    benefit: 'Grow without infrastructure headaches',
