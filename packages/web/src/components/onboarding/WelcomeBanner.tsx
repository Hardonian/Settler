        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-green-800 dark:text-green-200 mb-2">
              Your reconciliation workspace is ready. Connect your data sources, run your first
              match, and review results.
            </p>
            <p className="text-sm text-green-700 dark:text-green-300 mb-4">
              Start by creating an API key, then try the playground to see how Settler matches
              records and surfaces mismatches.
            </p>
            <div className="flex flex-wrap gap-3">
              <Button asChild size="sm" className="bg-green-600 hover:bg-green-700 text-white">
                <Link href="/console/api-keys">Create Your First API Key</Link>
              </Button>
              <Button
                asChild
                variant="outline"
              ...
              >
                <Link href="/console/playground">Try the Playground</Link>
              </Button>
              <Button
                asChild
                variant="ghost"
