...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles = [
      ...
      "leading-[1.4]",
      // Prevent awkward mid-word button wrapping
      "whitespace-nowrap",
    ...
    const variants = {
      ...
      // 'primary' is an alias for 'default' — kept for backwards compatibility
      primary: [
        "bg-primary-600 text-white",
        "hover:bg-primary-700 hover:shadow-md",
        "active:bg-primary-800 active:shadow-sm",
      ...
      // ^ identical to 'default', consumers should use variant="default"
    };
