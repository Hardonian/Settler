  ...
  try {
    ...
    if (result.error) {
      ...
      if (
        ...
        await safeLogger.debug("[SafeQuery] Table does not exist, returning empty result", {
          errorCode,
          errorMessage,
        });
        return {
      ...
      if (
        ...
        await safeLogger.debug("[SafeQuery] Permission denied by RLS, returning empty result", {
          errorCode,
          errorMessage,
        });
        return {
