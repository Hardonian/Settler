...
export function getTenantColorClasses(theme: TenantTheme | null): {
  ...
  return {
    primary: theme.colors.primary !== DEFAULT_COLOR_TOKENS.primary[600]
      ? '' // Will use inline style
      : 'text-primary-600',
    secondary: theme.colors.secondary !== DEFAULT_COLOR_TOKENS.electric.purple
      ? ''
      : 'text-electric-purple',
    accent: theme.colors.accent !== DEFAULT_COLOR_TOKENS.electric.cyan
      ? ''
      : 'text-electric-cyan',
