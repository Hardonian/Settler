...
function getStaticPaths(): Array<{
  ...
  return [
    ...
    // Public marketing and evaluation surfaces. Authenticated, admin, console,
    // dashboard, API, review, and demo routes are deliberately excluded.
    ...
    { path: "/managed", priority: 0.8, changeFrequency: "monthly" },
    ...
    { path: "/docs/integrations", priority: 0.7, changeFrequency: "weekly" },
    { path: "/docs/auth", priority: 0.6, changeFrequency: "monthly" },
    { path: "/docs/webhooks", priority: 0.6, changeFrequency: "monthly" },
    { path: "/docs/architecture/platform-architecture", priority: 0.6, changeFrequency: "monthly" },
    { path: "/docs/launch", priority: 0.6, changeFrequency: "monthly" },
    ...
    { path: "/legal/aup", priority: 0.4, changeFrequency: "yearly" },
    { path: "/legal/subprocessors", priority: 0.4, changeFrequency: "yearly" },
