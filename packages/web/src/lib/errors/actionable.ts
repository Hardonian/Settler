...
const ERROR_GUIDANCE: Record<string, ActionableError> = {
  USAGE_LIMIT_EXCEEDED: {
    ...
    action:
      "Upgrade your plan or wait for the next billing period. View your usage at /console/usage",
  ...
  RATE_LIMIT_EXCEEDED: {
    ...
    action:
      "Wait before retrying or upgrade your plan for higher limits. Check rate limits at /docs/rate-limits",
 ...
 */
export function createActionableErrorResponse(code: string, customMessage?: string) {
