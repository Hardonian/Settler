...
const SETTLER_IMAGES_CONFIG = {
  ...
  favicon192: {
    ...
    width: 192,
    height: 192,
    alt: `${BRAND_STRINGS.productSiteName} icon 192`,
    category: "favicon" as const,
    mimeType: "image/png",
  },
  favicon512: {
    ...
    width: 512,
    height: 512,
    alt: `${BRAND_STRINGS.productSiteName} icon 512`,
    category: "favicon" as const,
    mimeType: "image/png",
  },
  faviconPng: {
  ...
  ogImage: {
    ...
    width: 1200,
    height: 630,
    alt: `${BRAND_STRINGS.productSiteName} — Deterministic Reconciliation`,
  ...
  logoSquareLight: {
    ...
    width: 192,
    height: 192,
    alt: `${BRAND_STRINGS.productSiteName} mark`,
    category: "logo" as const,
    mimeType: "image/png",
  },
  logoIconLight: {
