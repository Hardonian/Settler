 ...
 */
export async function trackFunnelTransition(transition: FunnelTransition): Promise<void> {
  try {
 ...
 */
export async function getCurrentFunnelStage(userId: string): Promise<FunnelStage> {
  try {
