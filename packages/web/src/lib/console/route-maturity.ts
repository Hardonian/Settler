...
export const CONSOLE_ROUTE_REGISTRY: readonly ConsoleRouteEntry[] = [
  ...
  {
    href: "/console/dashboards/liquidity",
    ...
    externalProviderRequired: false,
    explicitDisclosureRequired: false,
    degradedBehavior: "Liquidity metrics.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
  ...
  {
    href: "/console/intelligence/rule-discovery",
    ...
    externalProviderRequired: false,
    explicitDisclosureRequired: false,
    degradedBehavior: "AI rule mining display.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
  {
    href: "/console/support/crm",
    label: "CX Support",
    section: "Exception ops",
    domain: "analytics",
    maturity: "runtime-operational",
    ...
    externalProviderRequired: false,
    explicitDisclosureRequired: false,
    degradedBehavior: "Zendesk/CRM Sync portal.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
  ...
  {
    href: "/console/developers/schema-registry",
    ...
    externalProviderRequired: false,
    explicitDisclosureRequired: false,
    degradedBehavior: "Schema list rendered normally.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
  ...
  },
  {
    ...
    explicitDisclosureRequired: false,
    degradedBehavior:
      "Fails closed on auth or missing tenant scope; audit + operator-runtime signal when accepted.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
  ...
  },
  {
    ...
    externalProviderRequired: false,
    explicitDisclosureRequired: false,
    degradedBehavior: "Data geo-fencing limits.",
    navTreatment: "secondary",
    ctaRestrictions: "none",
    dataMode: "operational",
  },
