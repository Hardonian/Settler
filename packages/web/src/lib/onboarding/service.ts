...
const ONBOARDING_STEPS: OnboardingStepInfo[] = [
  {
    ...
    description: "Get oriented — understand what Settler does and how the console works",
  ...
  },
  {
    ...
    description: "Generate a key to connect your systems or run reconciliations via the API",
  ...
  {
    id: "try_playground",
    title: "Run a Test Reconciliation",
    description: "Use the playground to see how Settler matches records and surfaces mismatches",
  ...
  },
  {
    ...
    description: "Add operators, reviewers, or admins so your team can triage exceptions together",
    actionLabel: "Invite Team",
    actionUrl: "/console/settings",
    optional: true,
  },
  {
    id: "complete",
    title: "You're Live",
    description: "Your workspace is configured and ready for production reconciliations",
