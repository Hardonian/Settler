 ...
 */
export async function getWorkspaceMembership(workspaceId: string): Promise<AuthzResult> {
  try {
 ...
 */
export async function requireWorkspaceMembership(workspaceId: string): Promise<WorkspaceMember> {
