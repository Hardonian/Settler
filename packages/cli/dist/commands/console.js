...
exports.consoleCommand = new commander_1.Command('console')
...
// Usage subcommand
const usageCommand = new commander_1.Command('usage')
...
usageCommand
    ...
    try {
        ...
        if (summary.byService && Object.keys(summary.byService).length > 0) {
            console.log(chalk_1.default.bold('\nBy Service:'));
            Object.entries(summary.byService).forEach(([service, count]) => {
...
const healthCommand = new commander_1.Command('health')
