...
exports.extractWebhookTimestamp = extractWebhookTimestamp;
exports.verifyWebhookSignatureWithTimestamp = verifyWebhookSignatureWithTimestamp;
function getCrypto() {
    // Node.js environment
    ...
    throw new Error("Webhook signature verification requires Node.js crypto module or a crypto library");
}
/**
 ...
 */
function extractWebhookTimestamp(signature) {
    const parts = signature.split(",");
 ...
 */
function verifyWebhookSignatureWithTimestamp(payload, signature, secret, maxAge = 5 * 60 * 1000 // 5 minutes
) {
