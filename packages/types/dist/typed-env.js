...
const serverEnvBuildSchema = zod_1.z
    .object({
    NODE_ENV: zod_1.z.enum(["development", "production", "test"]).default("development"),
    ANON_KEY: zod_1.z.string().min(1).optional(),
    SERVICE_ROLE_KEY: zod_1.z.string().min(1).optional(),
    ...
    RESEND_API_KEY: zod_1.z.string().optional(),
    RESEND_FROM_EMAIL: zod_1.z.string().email().optional(),
    TIGERBEETLE_ENABLED: zod_1.z.string().optional(),
    TIGERBEETLE_ADDRESS: zod_1.z.string().optional(),
    TIGERBEETLE_CLUSTER_ID: zod_1.z.string().optional(),
    TIGERBEETLE_TIMEOUT_MS: zod_1.z.string().optional(),
    TIGERBEETLE_MAX_RETRIES: zod_1.z.string().optional(),
    SUPABASE_AUTH_ENABLED: zod_1.z.string().optional(),
    SUPABASE_ENTERPRISE_SSO_ENABLED: zod_1.z.string().optional(),
    SUPABASE_ENTERPRISE_SSO_PROVIDER_ID: zod_1.z.string().optional(),
    SUPABASE_ENTERPRISE_SSO_DOMAIN: zod_1.z.string().optional(),
