...
let allPartners: Partner[] = [...integrationTargets, ...coMarketingTargets, ...podcastTargets];
...
fs.writeFileSync(`${outputDir}/partners-${timestamp}.json`, JSON.stringify(allPartners, null, 2));
