  ...
  linkedin: [
    {
      ...
      signals: ["hiring finance director"],
    },
    {
      company: "MarketHub",
      employees: 250,
      ...
      signals: ["multi-currency expansion"],
    },
    {
      company: "SaaSBilling",
      employees: 80,
      ...
      signals: ["transaction volume 10x"],
    },
  ],
  angellist: [
    {
    ...
    },
    {
      ...
      signals: ["reconciliation challenges"],
    },
  ],
  g2: [
    {
      ...
      employees: 65,
      funding: "Series A",
      techStack: ["Stripe", "SAP"],
      signals: ["negative reconciliation reviews"],
    },
    {
      company: "BillSync",
      employees: 200,
      funding: "Series C",
      techStack: ["Square", "Oracle"],
      signals: ["seeking automation"],
    },
  ],
};
...
function scoreProspect(company: any): "high" | "medium" | "low" {
  ...
  // Pain signals
  if (company.signals.some((s: string) => s.includes("reconcil") || s.includes("finance")))
    score += 3;
