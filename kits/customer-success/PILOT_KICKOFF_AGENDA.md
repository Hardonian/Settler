...
**Purpose:** Structured agenda for pilot kickoff calls
...
- **Ensure success:** Set up for successful pilot

**Philosophy:** Set up for success, not failure.
...
3. **Data**
   ...
   - "Do you have sample data available?"
...
1. **Account Setup**
   ...
   - Verify email, workspace name
   - Set up API keys

2. **API Connections**
   - Connect Stripe API (if applicable)
   - Connect Shopify API (if applicable)
   - Connect QuickBooks API (if applicable)
   - Verify connections working

3. **Reconciliation Job Setup**
...
- [ ] **Value demonstrated:** Customer sees value
...
- [ ] **Update CRM:** Update pipeline status
