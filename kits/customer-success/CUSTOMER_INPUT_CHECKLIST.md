...
**Purpose:** Checklist of inputs required from customers for successful pilot
...
- **Avoid delays:** Prevent pilot delays due to missing inputs

**Philosophy:** Make it easy for customers to say yes, but be clear about requirements.
...
- Pain points (time, errors, compliance)
- Success criteria

**Timeline:** Day 1 of pilot (kickoff call)
...
Thanks for signing up for Settler's 14-day pilot. To get started, I need a few things from you:

**Required:**
1. API access to your systems (Stripe, Shopify, QuickBooks, etc.)
2. Sample data (at least 1K transactions)
3. Use case details (what you're trying to solve)

**Optional:**
4. Historical data (for comparison)
5. Integration requirements (if any)

I'll send you setup guides and help you get started. Let me know if you have questions.
...
Just checking in. Have you been able to gather the required inputs? If you need help with API setup or data export, let me know.
