...
**Purpose:** Checklist for closing deals and converting pilots to paid
...
- **Complete deal:** Process upgrade, confirm commitment

**Philosophy:** Close when ready, not when convenient.
...
- [ ] **Budget approved:** Budget confirmed or pending approval
...
- [ ] **Accuracy:** Customer achieved 95%+ match rate
...
- [ ] **ROI clear:** Customer sees ROI (10x+ within first month)
...
**Action:** Close immediately, don't wait.
...
- ⚠️ "We're not ready yet"

**Action:** Address concerns, set follow-up date, don't force close.
...
**Action:** Disqualify politely, reconnect later.
