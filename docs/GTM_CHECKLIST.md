...
**Purpose:** Turn strategy into motion - executable by one person
...
- **Follow-up cadence:** When to follow up, what to say
- **Close criteria:** When to close, how to close

**Philosophy:** Make this runnable by one person (solo founder).
...
- [ ] **Value Props Defined:** Complete `/docs/VALUE_PROPOSITIONS.md`
...
- [ ] **Sales Qualification:** Complete `/docs/SALES_QUALIFICATION.md`
- [ ] **Discovery Questions:** Complete `/docs/DISCOVERY_QUESTIONS.md`
...
- [ ] **Onboarding Guide:** Review `/docs/ONBOARDING_GUIDE.md`
...
- [ ] **Product Ready:** Pilot gating, billing enforcement implemented
...
I noticed [Company] processes payments through Stripe and Shopify. Are you spending 2+ days every month manually reconciling payments?
...
Would you like to try a 14-day pilot? No credit card required.
...
Just following up. Are you still spending 2+ days/month on reconciliation?

If so, I'd love to show you how Settler can automate this. 14-day pilot, no credit card required.
...
Last chance to try Settler's 14-day pilot. No credit card required.

If reconciliation isn't a priority right now, no problem. I'll reconnect in 3 months.
...
I noticed [Company] processes multi-currency transactions. Are you manually reconciling currencies?

Settler automates multi-currency reconciliation with deterministic currency conversion—completes in <30 minutes, 99%+ accuracy, eliminates currency errors.
...
**Follow-up:** Same as Sequence 1 (Day 5, Day 10)
...
- **Unlimited Usage:** No usage limits during pilot
...
**Ready to start?** Sign up at [settler.dev/signup] or reply to this email."
...
**Demo:**
"Let me show you Settler. This is the Developer Console. Here's how you connect your APIs—Stripe, Shopify, QuickBooks. Here's how you create a reconciliation job. Here's how you run it. Here are the results—matched transactions, unmatched items, complete audit trail."

**Value:**
"This reconciliation processed 10K transactions in 5 minutes. 99.5% matched automatically. This would have taken 20 hours manually. With Settler, it took 5 minutes."

**Close:**
"Would you like to try a 14-day pilot? No credit card required. You can set it up in 30 minutes and see value immediately."
...
**Stop Language:**
"I understand Settler may not be the right fit right now. I'll reconnect in 3 months to see if your situation has changed."
...
- `/docs/REVENUE_METRICS.md` - Revenue metrics
