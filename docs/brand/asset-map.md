...
| ------------------------------------------ | ------------------------------------------------------------- | --------------------------------------------------- | ------------------------- | ------------------ | ------------------------------------------------------------------------------- |
| _(in-app)_ `BrandWordmark`                 | Text wordmark “Settler” / “Settler.dev”                       | Nav, footer, auth stacked lockup                    | Follows `text-foreground` | Vector (DOM)       | `BrandWordmark.tsx`, `BrandLockup.tsx`                                          |
