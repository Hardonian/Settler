...
- You can inspect mismatches and proof artifacts.
...
- Determinism/replay claims are limited to what automated checks verify in current scripts, as documented in the claim validation matrix.
