...
1. **NEXT_PUBLIC_ Variables**: These are exposed to the browser. Only use for non-sensitive configuration.
...
4. **Build vs Runtime**: Some variables are needed at build-time (NEXT_PUBLIC_*), others at runtime.
