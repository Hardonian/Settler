...
| -------------------------------- | -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Deterministic replay             | UI: `/console/replay` (canonical), `/app/replay` (legacy redirect), API: `/api/v1/runs/:id/replay`             | Re-run historical reconciliations and detect drift with explicit match status.                | Replayability + deterministic verification for financial runs.                     | Mature                                                                     |
