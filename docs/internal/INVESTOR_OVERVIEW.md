...
_For technical deep-dives, see [PRODUCT_OVERVIEW.md](PRODUCT_OVERVIEW.md), [SECURITY_INVARIANTS.md](SECURITY_INVARIANTS.md), and the [operator console demo](/demo/console)._
