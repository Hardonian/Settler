...
Complete catalog of premium add-ons available for Settler.dev.

## Standard Add-Ons (Included in Base Plan)
...
**Usage:** Included in base plan, no additional cost.
...
**Usage Price:** $0.02 per order + $0.01 per ad event  
...
- Businesses using messaging for order confirmations
...
4. Confirm purchase
5. Add-on is immediately available
