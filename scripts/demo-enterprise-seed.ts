...
const DEMO_SOURCES_DATA = [
  ...
  },
  {
    ...
    lastSyncError: "OAuth token expired. Re-authentication required. Last successful sync: 3 days ago.",
    syncSchedule: "0 */12 * * *",
...
function buildSources(): DemoSource[] {
  return DEMO_SOURCES_DATA.map((source) => ({
    ...source,
    id: seededUuid(),
