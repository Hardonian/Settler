-- Supabase AI Auto-Remediation Prompt
-- Execute this SQL to ensure all receipt tables, indexes, RLS policies, and functions exist
...
-- Ensure receipt_uploads table exists
...
-- Ensure receipt_items table exists
...
-- Create RLS policy for receipt_uploads
...
-- Create RLS policy for receipts
...
-- Create RLS policy for receipt_items
