...
const routesToVerify = [
  ...
  {
    path: "packages/web/src/app/api/console/subscription-status/route.ts",
    type: "API",
    method: "GET",
  },
  ...
  {
    path: "packages/web/src/components/console/TenantsObservabilityDashboard.tsx",
    type: "Component",
  },
...
function verifyRoute(route: { path: string; type: string; method?: string }) {
  ...
  try {
    ...
    if (route.type === "API" && route.method) {
      if (
        !content.includes(`export const ${route.method}`) &&
