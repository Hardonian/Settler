...
// ---------------------------------------------------------------------------
function verifyBundleDirectoryExists(): void {
...
// ---------------------------------------------------------------------------
function verifyRequiredControlFiles(): void {
  console.info("\n=== Step 2: Required control files ===");
...
// ---------------------------------------------------------------------------
function verifyManifestIntegrity(manifestAbsPath: string): Record<string, unknown> {
  console.info("\n=== Step 4: Manifest integrity ===");
...
// ---------------------------------------------------------------------------
function verifyManifestChecksums(manifest: Record<string, unknown>): void {
  console.info("\n=== Step 5: Cross-reference manifest.checksums vs recomputed ===");
...
// ---------------------------------------------------------------------------
function verifyRequiredArtifactPresence(manifest: Record<string, unknown>): void {
  console.info("\n=== Step 6: Required artifact presence ===");
...
// ---------------------------------------------------------------------------
function verifyCompletenessAndStatus(manifest: Record<string, unknown>): void {
...
function main() {
  ...
  console.info(`[verify-release-bundle] Bundle path: ${bundleRel}/`);
  console.info("");

  verifyBundleDirectoryExists();
  verifyRequiredControlFiles();
  verifyChecksums();
  ...
  const manifest = verifyManifestIntegrity(manifestAbsPath);
  verifyManifestChecksums(manifest);
  verifyRequiredArtifactPresence(manifest);
  verifyCompletenessAndStatus(manifest);
