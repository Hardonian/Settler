...
function getProjectRef(): string {
  ...
  throw new Error("Supabase project reference not found. Set SUPABASE_PROJECT_REF or SUPABASE_URL");
}
...
async function regenerateTypes() {
  ...
  const outputPath = path.join(process.cwd(), "packages/web/src/types/database.types.ts");
