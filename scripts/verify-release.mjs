...
const stageCatalog = {
  ...
  reconciliationTopology: {
    label: "Reconciliation topology contract",
    command: ["pnpm", ["run", "verify:reconciliation-topology"]],
    timeoutMs: 60_000,
  },
  envContract: {
  ...
  acquisitionReadiness: {
    label: "Acquisition-readiness truth",
    command: ["pnpm", ["run", "verify:acquisition-readiness"]],
    timeoutMs: 3 * 60_000,
  },
  securityClaims: {
    label: "Buyer-facing security claims",
    command: ["pnpm", ["run", "verify:security-claims"]],
    timeoutMs: 3 * 60_000,
  },
  boundaries: {
