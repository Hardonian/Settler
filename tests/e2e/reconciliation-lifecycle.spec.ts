      ...
      if (pollCount <= 2) {
        ...
        await route.fulfill({
          ...
          body: JSON.stringify({
            ...
            items: [
              { id: 'item-1', status: 'unmatched', sourceAmount: 100, sourceCurrency: 'USD', targetAmount: 0, targetCurrency: 'USD', delta: 100, impact: { riskScore: 0.8, confidence: 0.5 }, urgency: 'high' },
            ],
          }),
        });
      }
