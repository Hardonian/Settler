...
- dependency_evidence_status: PASS_WITH_DEGRADED_EVIDENCE (degraded) — Local dependency audit artifact was not available. Local dependency audit was degraded: pnpm-audit-backend-unavailable, osv-scanner-missing. Authenticated advisory completeness is unauthenticated.
- advisory_completeness_status: CONDITIONAL (unauthenticated) — No authenticated advisory source configured.
- tenant_isolation_status: PASS (runtime-api) — Cross-tenant runtime denial checks passed.
