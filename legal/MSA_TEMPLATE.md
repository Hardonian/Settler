...
**Purpose:** Master Services Agreement template for Enterprise customers
...
- Easy negotiation and execution
...
**Term:** [Initial Term] with automatic renewal unless terminated
...
- Custom integrations (if specified in Order Form)
- Support services (as specified in Order Form)
...
- **Keep it simple:** This template is designed for low-friction execution
- **Avoid overpromising:** No false SLAs, no unrealistic commitments
- **Easy customization:** Modular sections for easy negotiation
